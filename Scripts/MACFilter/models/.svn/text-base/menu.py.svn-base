...
response.subtitle = T('MAC Filter!')

#http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Guido Accardo <gaccardo@coresecurity.com>'
response.meta.description = 'Web application to manage wich devices can connect to Core access points'
...
response.menu += [
    (T('Administración'), False, None, 
    [
        (T('ABM Esquemas'), False, URL('default', 'listEsquemas'),
           [(T('Agregar Esquema'), False, URL('default', 'data', args=['create', 'esquema'])),
           ]),
        (T('ABM Aps'), False, URL('default', 'listAps'),
           [(T('Agregar AP'), False, URL('default', 'data', args=['create', 'ap'])),
           ]),
        (T('ABM Vlans'), False, URL('default', 'listVlans'),
           [(T('Agregar Vlan'), False, URL('default', 'data', args=['create', 'vlan'])),
           ]),
        (T('ABM Devices'), False, URL('default', 'listDevices'), 
           [(T('Agregar Device'), False, URL('default', 'data',args=['create','device'])),
           ]),
    ]
    )
    ]
    
response.menu += [ (T('SYNC'), False, URL('default', 'syncker')) ]
